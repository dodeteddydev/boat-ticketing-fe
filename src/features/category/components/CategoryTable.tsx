...
type CategoryTableProps = {
  ...
  isError?: boolean;
  errorStatus?: number;
  data: SuccessListResponse<CategoryResponse[]> | undefined;
  onClickDetail?: (data: CategoryResponse) => void;
  onClickUpdate?: (data: CategoryResponse & { id: number }) => void;
  onClickDelete?: (data: CategoryResponse) => void;
};
...
export const CategoryTable = ({
  ...
  const dataList: CategoryResponse[] = data?.data ?? [];
...
const ToggleCategory = ({
  ...
  const updateActive = useActiveCategory();
